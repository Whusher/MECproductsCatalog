  ...
  const navigationList = [
    {
      ...
      svg: (
        ...
        <span className="group-hover:text-black text-[#637381]">Home</span>
        </Link>
      ),
    },
    {
      //boton para Mis ventas
      svg: (
        <Link to="/sales" className="flex items-center space-x-2 group">
        <svg
          width="18"
          height="18"
          viewBox="0 0 18 18"
        ...
        <span className="group-hover:text-[#4F80E1] text-[#637381]">Mis ventas</span>
        </Link>
      ),
    },
    {
      //Boton para crud de productos
      svg: (
        <Link to="/products" className="flex items-center space-x-2 group">
          ...
          <span className="group-hover:text-[#4F80E1] text-[#637381]">Gestión de Productos</span>
        </Link>
      ),
    },
    ...
    state.rol === 'admin' && 
    {
      //boton para Creación de usuarios
      svg: (
        <Link to="/sellers" className="flex items-center space-x-2 group">
          <svg
            width="18"
            height="18"
            viewBox="0 0 24 24"
          ...
          <span className="group-hover:text-[#4F80E1] text-[#637381]">Gestión de Usuarios</span>
          </Link>
      ),
    }, 
  ];
